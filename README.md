...
**[👉 Tool öffnen](https://tweilandlpz.github.io/pokerabend-tool/)**
...
2. Die Datei `poker_equity_trainer.html` hochladen und dabei in **`index.html`** umbenennen.
3. Unter **Settings → Pages** als Quelle den `main`-Branch, Ordner `/ (root)` auswählen und speichern.
4. Nach ca. 1 Minute ist die Seite live unter `https://DEIN-USERNAME.github.io/REPO-NAME/`.
